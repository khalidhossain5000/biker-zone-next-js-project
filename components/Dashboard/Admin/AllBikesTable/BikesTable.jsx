        ...
        <TableBody>
          {AllBikes.map((bike, index) => (
            <TableRow key={bike._id} className="">
              ...
              <TableCell><img src={bike.image} alt="bike image" className="w-14 rounded-full"/></TableCell>
               ...
               <TableCell>{bike.colors.map((color,i)=><h2 key={i}>{color}</h2>)}</TableCell>
               <TableCell>{bike.price}</TableCell>
               <TableCell>{bike.quantity}</TableCell>
               <TableCell>{bike.mileage}</TableCell>
               <TableCell><button>View Descriptions</button></TableCell>
